document.addEventListener('DOMContentLoaded', () => {
  ...
  function createRecipeCard(recette, index) {
    ...
    recette.ingredients.forEach((ingredient) => {
      ...
      addIngredientToCartButton.innerHTML = '<i class="bi bi-cart-plus"></i> Add';
    ...
    favori.addEventListener('click', () => {
      if (isFavorited(recette)) {
        ...
        favoriteRecipes = favoriteRecipes.filter((fav) => fav.nom !== recette.nom);
        favori.innerHTML = '<i class="bi bi-heart" style="color: red;"></i> Add to favorites';
      } else {
    ...
    addAllToCartButton.innerHTML = '<i class="bi bi-cart-plus"></i> Add All to Cart';
